import svgPaths from "./svg-phwqg3s5q2";
...
function Frame() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <p className="font-['PP_Fragment:Serif_Light',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-nowrap text-white tracking-[1.2px] uppercase whitespace-pre">Back</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start pb-[50px] pt-0 px-0 relative shrink-0">
      ...
      <p className="font-['SUIT:Medium',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[14px] text-white uppercase w-[min-content]">성분표</p>
      <div className="h-0 relative shrink-0 w-[637px]">
        <div className="absolute bottom-[-0.25px] left-0 right-0 top-[-0.25px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 637 1">
            <path d="M0 0.25H637" id="Vector 104" stroke="var(--stroke-0, white)" strokeWidth="0.5" />
      ...
      <p className="font-['SUIT:Medium',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[14px] text-white uppercase w-[min-content]">사용방법</p>
      <div className="h-0 relative shrink-0 w-[637px]">
        <div className="absolute bottom-[-0.25px] left-0 right-0 top-[-0.25px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 637 1">
            <path d="M0 0.25H637" id="Vector 104" stroke="var(--stroke-0, white)" strokeWidth="0.5" />
      ...
      <p className="font-['SUIT:Medium',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[14px] text-white uppercase w-[min-content]">향 노트</p>
    </div>
  );
}
...
function ImageHold() {
  return (
    <div className="content-stretch flex gap-[31px] items-center overflow-clip relative shrink-0 w-[1219px]" data-name="image hold">
      <div className="h-[900px] relative shrink-0 w-[719px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[101.78%] left-[-13.44%] max-w-none top-[-1.78%] w-[129.14%]" src={imgRectangle226} />
        </div>
      </div>
      <div className="h-[900px] relative shrink-0 w-[719px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[119.71%] left-0 max-w-none top-[-18.75%] w-full" src={imgRectangle222} />
        </div>
      </div>
      <div className="h-[900px] relative shrink-0 w-[719px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[127.67%] left-[-3.29%] max-w-none top-[-17.78%] w-[106.59%]" src={imgRectangle225} />
        </div>
      </div>
      <div className="h-[900px] relative shrink-0 w-[719px]">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgRectangle224} />
      </div>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[100px] items-start left-[342px] top-[251px] w-[1237px]">
      <PageDetail />
      <ImageHold />
    </div>
  );
